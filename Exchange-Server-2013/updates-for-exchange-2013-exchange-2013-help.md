...
To get the latest version of Exchange 2013, download and install [Microsoft Exchange Server 2013 Cumulative Update 20](https://go.microsoft.com/fwlink/p/?linkid=870406). Because each CU is a full installation of Exchange and includes updates and changes from all previous CU's, you don't need to install any previous CU's or service packs first.
