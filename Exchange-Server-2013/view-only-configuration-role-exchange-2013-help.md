...
This role can be combined with roles associated with the `View-Only Recipients` role to create a role group that can view every object in an organization. For more information, see [View-Only Recipients role](view-only-recipients-role-exchange-2013-help.md).
